...
const CEA_REST_URL = process.env.CEA_REST_URL;
const CEA_SOAP_CONTRACT_URL = process.env.CEA_SOAP_CONTRACT_URL;
const CEA_SOAP_WORKORDER_URL = process.env.CEA_SOAP_WORKORDER_URL;
const CEA_SOAP_METER_URL = process.env.CEA_SOAP_METER_URL;
const CEA_SOAP_DEBT_URL = process.env.CEA_SOAP_DEBT_URL;
const CEA_SOAP_READINGS_URL = process.env.CEA_SOAP_READINGS_URL;
const CEA_SOAP_RECEIPT_URL = process.env.CEA_SOAP_RECEIPT_URL;
const CEA_API_USERNAME = process.env.CEA_API_USERNAME;
const CEA_API_PASSWORD = process.env.CEA_API_PASSWORD;
...
export const xmlToJson = (node: Document | Element): any => {
  ...
  const parseChild = (child: Element) => {
    ...
    const childElements = Array.from(child.childNodes).filter(n => n.nodeType === 1);
...
// Helper to get parsed JSON directly from SOAP response
